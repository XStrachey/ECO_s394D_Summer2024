...
ggplot(profs) +
  ...
  labs(x = "Physical attractiveness (rating units)",
       y = "Course evaluation scores (score)",
    caption = str_wrap("<b>Figure 4.</b> Regardless of the rating of physical attractiveness scores, course evaluation scores shows great <br>spread. And there is a linear correlation (correlation = 0.189) between a professor's physical attractive-<br>ness and their course evaluations.")) +
  theme(
    # use ggtext::element_markdown() to render Markdown
    plot.caption = element_markdown())
```
