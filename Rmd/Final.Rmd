...
**For continuous:** $E(X)=\int_{-\infty}^{+\infty}xf(x)dx$
...
$E(X|Y=y)$ is a function of $y$, named as the regression function of $X$ by $Y$.
...
**For continuous:** $var(X)=\int_{-\infty}^{+\infty}f(x)[x-E(X)]^2dx$
